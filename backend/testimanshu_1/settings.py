"""
Django settings for testimanshu_1 project.
...
ROOT_URLCONF = 'testimanshu_1.urls'
...
WSGI_APPLICATION = 'testimanshu_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testimanshu_1 API",
    "DESCRIPTION": "API documentation for testimanshu_1 App",
    "VERSION": "v1",
}
